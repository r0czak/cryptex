...
import org.atonic.cryptexsimple.controller.payload.request.OrderbookRequest;
...
public class TradeOrderController {
    ...
    public ResponseEntity<?> placeTradeOrder(@RequestBody PlaceOrderRequest request, Principal principal) {
